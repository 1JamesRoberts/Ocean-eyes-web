...
class OceanEyesProductionConfig {
  ...
  factory OceanEyesProductionConfig.fromEnvironment({Uri? launchUri}) {
    final uri = launchUri ?? Uri.base;
    final fixtureMode = uri.queryParameters.containsKey('fixture');
    return OceanEyesProductionConfig(
      enabled:
          !fixtureMode && const bool.fromEnvironment('OCEANEYES_PRODUCTION'),
