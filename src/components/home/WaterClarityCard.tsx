...
export const WaterClarityCard: React.FC<WaterClarityCardProps> = ({ displayClarity, onClick }) => {
  return (
    <div>
      ...
      <div 
        className="flex items-center gap-3 bg-surface-card p-4 rounded-2xl border border-[rgba(13,148,136,0.02)] shadow-card cursor-pointer transition-[all_0.25s_cubic-bezier(0.4,0,0.2,1)] hover:-translate-y-0.5 hover:shadow-[0_8px_24px_rgba(13,148,136,0.08)]"
        onClick={onClick}
      >
